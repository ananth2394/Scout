...
public class AbsoluteGrid{
    ...
    public void setLocation(Point loc, int val)
    {
      this.grid[loc.x][loc.y] = val;
    }

    public int getLocation(Point loc)
    {
    ...
    public static void mergeMin(AbsoluteGrid A1, AbsoluteGrid A2){
      int[][] a1 = A1.getGrid();
      int[][] a2 = A2.getGrid();
