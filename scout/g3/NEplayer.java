...
public class NEplayer extends DirectionalPlayer {
    ...
    */
    ...
    private void findSection() {
        ...
        //moveTo(northEnd, eastEnd, PlayerPhase.Explore);
    }
    ...
    private void joinOutpost() {
        moveTo(outpostLocations.get(0).x, outpostLocations.get(0).y, PlayerPhase.Explore);
    }
    ...
    private void NEpath() {
        ...
        while(topX != southEnd || topY != eastEnd) {
            ...
            if(topY == eastEnd) {
                ...
                nextY = topY + 3 > eastEnd ? eastEnd - topY : 3;
                nextX = 1;
                down = !down;
            } else if(down) {
                nextX = 1;
